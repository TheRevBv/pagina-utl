      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div
              className="bd-feedback-thumb-wrapper mb-60 p-relative wow fadeInLeft"
          ...
          <div className="col-lg-6">
            ...
            >
              <h2 className="bd-section-title mb-5">
                {rectora_data[0].title}
                {/* Playful learning
                <br />
                helps children */}
              </h2>
              <p>{rectora_data[0].mensaje}</p>
            </div>
            <div
            ...
            >
              <div className="bd-feedback-content">
                <p className="mb-25">
                  “This seemed great for my kindergartener-to-be, a full santa
                  believer. Not so the winter holiday episode, and {`I'm`} not
                  sure how {`I'm`} going to police. I really happy to see my
                  child there”
                </p>
